...
import com.gitee.quiet.doc.vo.DocProjectConfigVO;
 ...
 */
@Mapper
public interface DocProjectConfigConvert
        extends QuietConvert<DocProjectConfig, DocProjectConfigDTO, DocProjectConfigVO> {
