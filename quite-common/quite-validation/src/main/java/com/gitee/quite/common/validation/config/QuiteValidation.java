...
package com.gitee.quite.common.validation.config;
...
public class QuiteValidation {
    ...
    public LocalValidatorFactoryBean getValidator(MessageSourceProperties properties) {
        ...
        localValidatorFactoryBean.setValidationMessageSource(
                MessageSourceUtil.buildMessageSource(properties, "quite-validation", "validation"));
