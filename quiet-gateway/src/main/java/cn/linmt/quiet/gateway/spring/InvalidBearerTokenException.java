...
package cn.linmt.quiet.gateway.spring;
...
public class InvalidBearerTokenException extends OAuth2AuthenticationException {
   ...
   *
   * <p>The description will be wrapped into an {@link
   * org.springframework.security.oauth2.core.OAuth2Error} instance as the {@code
   * error_description}.
   *
  ...
  /**
   * Construct an instance of {@link InvalidBearerTokenException} given the provided description and
   * cause
   *
   * <p>The description will be wrapped into an {@link
   * org.springframework.security.oauth2.core.OAuth2Error} instance as the {@code
