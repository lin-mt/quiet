...
public final class BearerTokenErrorCodes {
  ...
  /**
   * {@code invalid_request} - The request is missing a required parameter, includes an unsupported
  ...
  /**
   * {@code insufficient_scope} - The request requires higher privileges than provided by the access
   * token.
   */
